...
public class DefaultThreadActivity extends AppCompatActivity {
    public static final String TAG = DefaultThreadActivity.class.getName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_default_thread);
        doRxjavaWork();
    }
